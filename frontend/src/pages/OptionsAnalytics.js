  ...
  const CustomDot = (props) => {
    ...
    return (
      <circle
        ...
        fill={payload.is_expiry ? '#EF4444' : '#3B82F6'}
        stroke="none"
      />
    );
  };
    ...
    <div>
      <div className="ph">
        ...
        <p style={{ fontSize: '13px', color: '#555', marginTop: '3px' }}>
          ...
          <span style={{ fontSize: '11px', color: '#EF4444' }}>● Expiry (Thu)</span>
          <span style={{ marginLeft: '8px', fontSize: '11px', color: '#3B82F6' }}>● Normal day</span>
        </p>
      </div>
