        ...
        {noData ? (
          ...
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={data} margin={{ top: 8, right: 8, bottom: 8, left: 8 }}>
              ...
              <Bar dataKey="profitable_clients" name="Profitable clients" fill="#10B981" radius={[3,3,0,0]} />
              <Bar dataKey="loss_clients"       name="Loss clients"       fill="#EF4444" radius={[3,3,0,0]} />
            </BarChart>
          </ResponsiveContainer>
        )}
      </div>
