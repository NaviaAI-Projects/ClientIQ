              ...
              <tr key={r.key} style={{ borderBottom: '0.5px solid rgba(0,0,0,0.05)' }}>
                ...
                <td style={{ ...S.td, whiteSpace: 'nowrap' }}>
                  <button onClick={() => saveRow(r)}
                    style={{ padding: '4px 10px', fontSize: '12px', borderRadius: '5px', cursor: 'pointer', border: '0.5px solid rgba(0,0,0,0.2)', background: 'white', color: '#1B3F7A', marginRight: '6px' }}>
                    Update
                  </button>
                  {r.key.startsWith('rate_custom_') && (
...
const S = {
  ...
  btnPrimary: { padding: '8px 16px', background: '#1B3F7A', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer', fontSize: '13px', fontWeight: '600' },
  btnSecondary: { padding: '8px 16px', background: 'white', color: '#1B3F7A', border: '0.5px solid #223872', borderRadius: '5px', cursor: 'pointer', fontSize: '13px' }
};
