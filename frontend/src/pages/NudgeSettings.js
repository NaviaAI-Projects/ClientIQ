...
const NudgeSettings = () => {
  ...
  const btn = (primary) => ({ padding: '8px 16px', background: primary ? '#1B3F7A' : 'white', color: primary ? 'white' : '#1B3F7A', border: primary ? 'none' : '0.5px solid #223872', borderRadius: '5px', cursor: 'pointer', fontSize: '13px', marginRight: '8px' });
