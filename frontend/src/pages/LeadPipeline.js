...
const LeadPipeline = () => {
  ...
  return (
    <div>
      <div className="ph"><h2>Lead pipeline</h2><p>All active leads across all RMs · As of {new Date().toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}</p></div>
      <div className="cards">
