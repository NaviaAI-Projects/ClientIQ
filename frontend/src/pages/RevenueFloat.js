        ...
        {chartData.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={chartData} margin={{ top: 8, right: 8, bottom: 8, left: 8 }}>
              ...
              <Bar dataKey="options_clearing" name="Options clearing (40%)" stackId="s" fill="#3B82F6" />
              <Bar dataKey="equity_brokerage" name="Equity brokerage (30%)" stackId="s" fill="#10B981" />
              <Bar dataKey="float_income"     name="Float income (20%)"     stackId="s" fill="#8B5CF6" />
              <Bar dataKey="mtf_interest"     name="MTF interest (10%)"     stackId="s" fill="#F59E0B" radius={[4,4,0,0]} />
            </BarChart>
          </ResponsiveContainer>
        )}
      </div>
