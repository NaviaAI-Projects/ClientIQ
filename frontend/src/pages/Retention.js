          ...
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={cohortData} margin={{ top: 8, right: 8, bottom: 8, left: 8 }}>
              ...
              <Line type="monotone" dataKey="industry" name="Industry avg"
                stroke="#10B981" strokeDasharray="4 4" dot={false} strokeWidth={1.5} />
            </LineChart>
          </ResponsiveContainer>
          ...
          {reactivData.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={reactivData} margin={{ top: 8, right: 8, bottom: 8, left: 8 }}>
                ...
                <Tooltip />
                <Legend wrapperStyle={{ fontSize: 11 }} />
                <Bar dataKey="reactivated"  name="Reactivated clients"      fill="#10B981" />
                <Bar dataKey="rm_assisted"  name="RM-assisted reactivations" fill="#3B82F6" radius={[3,3,0,0]} />
              </BarChart>
            </ResponsiveContainer>
          )}
        </div>
