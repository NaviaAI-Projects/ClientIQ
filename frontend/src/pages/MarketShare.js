        ...
        {noData ? (
          ...
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={data} margin={{ top: 8, right: 8, bottom: 8, left: 8 }}>
              ...
              <Bar dataKey="navia_options_cr"  name="Eq Options + F&O (₹Cr)" fill="#3B82F6" radius={[3,3,0,0]} />
              <Bar dataKey="navia_eq_cash_cr"  name="Eq Cash (₹Cr)"          fill="rgba(59,130,246,0.35)" radius={[3,3,0,0]} />
              <Bar dataKey="navia_comm_cr"     name="Commodity F&O (₹Cr)"    fill="#10B981" radius={[3,3,0,0]} />
            </BarChart>
          </ResponsiveContainer>
        )}
      </div>
